...
description: Generate a structured, enterprise-grade Azure High-Level Design (HLD) document using Azure MCP tools. The design incorporates Cloud Architect recommendations, Well-Architected validation, Advisor insights, Pricing considerations, and Policy governance to produce a secure, scalable, cost-optimised architecture aligned to best practices.
metadata:
...
Use this skill to generate a high-level Azure architecture design document using Azure MCP tools including Cloud Architect, Well-Architected Framework, Pricing, Advisor, and Policy.
...
run: |
  ...
  Use the following Azure MCP Server tools and capabilities to generate a High-Level Design (HLD) document:
  ...
  - Use Azure UK regions for data residency unless otherwise specified
  ...
  - All cost estimates must be specified in UK pounds (£) and grounded in Azure Pricing tool insights
